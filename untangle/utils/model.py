...
def create_model(
    ...
    if prefix == "timm":
        try:
            ...
            # Try a common alias form (e.g., 'resnet_50' -> 'resnet50') before failing
...
def wrap_model(  # noqa: C901
    ...
    if model_wrapper_name == "correctness-prediction":
        ...
        wrapped_model = LaplaceWrapper(
            ...
            prior_precision_grid_size=prior_precision_grid_size,
            log_prior_precision_min=log_prior_precision_min,
            log_prior_precision_max=log_prior_precision_max,
        )

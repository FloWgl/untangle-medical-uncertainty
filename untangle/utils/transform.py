...
def create_transform(
    ...
    if is_training_dataset:
        ...
        elif "pathmnist" in dataset_name or "mhist" in dataset_name:
            transform = transforms_pathmnist_train(
                img_size=img_size,
                interpolation=interpolation,
                padding=padding,
                hflip=hflip,
        ...
        transform = transforms_pathmnist_eval(
            img_size=img_size,
            interpolation=interpolation,
            use_prefetcher=use_prefetcher,
            mean=mean,
...
def transforms_pathmnist_train(
    img_size: tuple[int, int],
    interpolation: str,
    padding: int,
    hflip: float,
    ...
    """Creates a transform for PathMNIST training."""
    tfl = []
    ...
    tfl += [transforms.RandomCrop(img_size, padding=padding)]
...
def transforms_pathmnist_eval(
    ...
    """Creates a transform for PathMNIST evaluation."""
    tfl = []
